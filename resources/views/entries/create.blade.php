...
<x-layout :title="__('entry.create')">
    ...
    <form action="{{ route('entry.store') }}" method="POST" class="flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-4 mb-4">
            ...
            <div x-data="{ option: 1 }" class="flex flex-col gap-4">
                ...
                <div x-show="option === 2" x-cloak>
                    <textarea name="statement_text" :disabled="option !== 2" placeholder="@lang('entry.placeholder.statement')" class="w-full" cols="30"
                        rows="3"></textarea>
                </div>

                <p class="text-gray-500 text-sm">@lang('entry.hint.statement')</p>
            </div>
            ...
            <div x-data="{ option: 1 }" class="flex flex-col gap-4">
                ...
                <div x-show="option === 2"  x-cloak>
                    <textarea name="solution" :disabled="option !== 2" placeholder="@lang('entry.placeholder.solution')" class="w-full" cols="30"
                        rows="3"></textarea>
                </div>
